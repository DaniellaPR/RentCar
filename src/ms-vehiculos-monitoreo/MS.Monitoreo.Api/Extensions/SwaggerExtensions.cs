...
namespace MS.Monitoreo.Api.Extensions   // ← CAMBIAR el namespace en cada MS
{
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            foreach (var description in _provider.ApiVersionDescriptions)
            {
                ...
                {
                    // ← CAMBIAR Title y Description en cada microservicio:
                    Title       = "RentCar Ec — MS.Monitoreo.Api",
                    Version     = description.ApiVersion.ToString(),
                    Description = description.IsDeprecated
                        ? "Microservicio de Monitoreo para Paula Pozo. [DEPRECADA]"
                        : "Microservicio de Monitoreo para Paula Pozo. " +
                          "Centraliza y expone los registros de auditoría y logs transaccionales del ecosistema."
                });
            }
        }
    }
