...
{
    public class CategoriaVehiculoRepository : RepositoryBase<CategoriaVehiculoEntity>, ICategoriaVehiculoRepository
    {
        public CategoriaVehiculoRepository(CatalogoDbContext context) : base(context)
        {
        }
    }
}